                                        ...
                                        <div class="row">
                                            <div class="col-12 text-sm-center form-inline" >
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <!-- <form method="POST">
                                                    <input name="search" type="text" placeholder="Search" class="form-control form-control-sm" autocomplete="on">
                                    ...
                                    <div class="table-responsive">
                                        <table id="demo-foo-filtering" class="table table-bordered toggle-circle mb-0" data-page-size="7">
                                            ...
                                            */
                                            ...
                                            //     }
                                                // $ret= $ret="SELECT * FROM  his_patients WHERE pat_number LIKE '$filtervalue' "; 
