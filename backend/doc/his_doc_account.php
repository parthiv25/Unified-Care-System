...
<!DOCTYPE html>
    ...
    <!-- PA  Issue exists it should hospital details not patient details   -->
                ...
                <div class="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-lg-6 col-xl-6">
                                <div class="card-box text-center">
                                    ...
                                    <div class="text-centre mt-3">
                                        <!-- PA To chage name of rows but data showed is of patient need self  PA  -->
                                        <p class="text-muted mb-2 font-13"><strong>Hospital Name :</strong> <span class="ml-2"><?php echo $row->doc_fname;?> <?php echo $row->doc_lname;?></span></p>
                                       <!-- <p class="text-muted mb-2 font-13"><strong>Employee Department :</strong> <span class="ml-2"><?php echo $row->doc_dept;?></span></p> -->
                                        <p class="text-muted mb-2 font-13"><strong>Hospital Number :</strong> <span class="ml-2"><?php echo $row->doc_number;?></span></p>
                                        <p class="text-muted mb-2 font-13"><strong>Hospital Email :</strong> <span class="ml-2"><?php echo $row->doc_email;?></span></p>
                            ...
                            <!-- PA  Comented to avoid vitals of patients on left PA  -->
