    ...
    <body>
        ...
        <div id="wrapper">
            ...
            <div class="content-page">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box">
                                    ...
                                    <h4 class="page-title">Unified Care System</h4>
                                </div>
                            </div>
                        </div>     
                        <!-- end page title --> 
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-6">
                                            <div class="text-right">
                                                ...
                                                <p class="text-muted mb-1 text-truncate">Central Assets</p>
                                            </div>
                                        </div>
                                    </div> <!-- end row-->
                                </div> <!-- end widget-rounded-circle-->
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-6">
                                            <div class="text-right">
                                                ...
                                                <p class="text-muted mb-1 text-truncate">Central Pharmaceuticals</p>
                                            </div>
                                        </div>
                                    </div> <!-- end row-->
                                </div> <!-- end widget-rounded-circle-->
                        ...
                        <!--Start Vendors-->
                           ...
                           <!-- end col--> 
                            ...
                            <!-- PA   To hide my payroll thing commented below part   PA -->
                        ...
                        <!-- PA   To hide the table of patients in dashboard done this  PA -->
                ...
                <!-- PA   To chnage the bottom footer to Unicare System , its backend/ assets/ inc   PA -->
                <!-- Footer Start -->
