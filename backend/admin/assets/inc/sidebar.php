                    ...
                    <div id="sidebar-menu">
                        ...
                        <ul class="metismenu" id="side-menu">
                            ...
                            <li>
                                ...
                                <ul class="nav-second-level" aria-expanded="false">
                                    <li>
                                        <a href="his_admin_add_employee.php">Add Partner</a>
                                    </li>
                                    <li>
                                        <a href="his_admin_view_employee.php">View Partners</a>
                                    </li>
                                    <li>
                                        <a href="his_admin_manage_employee.php">Manage Partners</a>
                                    </li>
                                    <hr>
                                    <!-- <li>
